...
replace (
	github.com/rancher/rancher/pkg/apis => /Users/ericp/workspace/rancher/rancher/pkg/apis
...
require (
	...
	github.com/rancher/rancher/pkg/apis v0.0.0-20240506132424-2b53406a5497
