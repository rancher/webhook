...
func (f *fakeResolver) GetRoleReferenceRules(_ rbacv1.RoleRef, _ string) ([]rbacv1.PolicyRule, error) {
	return nil, nil
}

func (f *fakeResolver) RulesFor(u user.Info, _ string) ([]rbacv1.PolicyRule, error) {
	return f.rulesFor(u.GetName())
}

func (f *fakeResolver) VisitRulesFor(_ user.Info, _ string, _ func(fmt.Stringer, *rbacv1.PolicyRule, error) bool) {
}
