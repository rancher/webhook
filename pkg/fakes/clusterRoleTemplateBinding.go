...
// Source: github.com/rancher/webhook/pkg/generated/controllers/management.cattle.io/v3 (interfaces: ClusterRoleTemplateBindingController,ClusterRoleTemplateBindingClient,ClusterRoleTemplateBindingCache)
...
type MockClusterRoleTemplateBindingClient struct {
	ctrl     *gomock.Controller
	recorder *MockClusterRoleTemplateBindingClientMockRecorder
}
...
type MockClusterRoleTemplateBindingClientMockRecorder struct {
	mock *MockClusterRoleTemplateBindingClient
}
...
func NewMockClusterRoleTemplateBindingClient(ctrl *gomock.Controller) *MockClusterRoleTemplateBindingClient {
	mock := &MockClusterRoleTemplateBindingClient{ctrl: ctrl}
	mock.recorder = &MockClusterRoleTemplateBindingClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockClusterRoleTemplateBindingClient) EXPECT() *MockClusterRoleTemplateBindingClientMockRecorder {
	return m.recorder
}

// Create mocks base method.
func (m *MockClusterRoleTemplateBindingClient) Create(arg0 *v3.ClusterRoleTemplateBinding) (*v3.ClusterRoleTemplateBinding, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0)
	ret0, _ := ret[0].(*v3.ClusterRoleTemplateBinding)
	ret1, _ := ret[1].(error)
...
func (mr *MockClusterRoleTemplateBindingClientMockRecorder) Create(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockClusterRoleTemplateBindingClient)(nil).Create), arg0)
}
...
func (mr *MockClusterRoleTemplateBindingClientMockRecorder) Delete(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockClusterRoleTemplateBindingClient)(nil).Delete), arg0, arg1, arg2)
}

// Get mocks base method.
func (m *MockClusterRoleTemplateBindingClient) Get(arg0, arg1 string, arg2 v1.GetOptions) (*v3.ClusterRoleTemplateBinding, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0, arg1, arg2)
	ret0, _ := ret[0].(*v3.ClusterRoleTemplateBinding)
	ret1, _ := ret[1].(error)
...
func (mr *MockClusterRoleTemplateBindingClientMockRecorder) Get(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockClusterRoleTemplateBindingClient)(nil).Get), arg0, arg1, arg2)
}

// List mocks base method.
func (m *MockClusterRoleTemplateBindingClient) List(arg0 string, arg1 v1.ListOptions) (*v3.ClusterRoleTemplateBindingList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", arg0, arg1)
	ret0, _ := ret[0].(*v3.ClusterRoleTemplateBindingList)
	ret1, _ := ret[1].(error)
...
func (mr *MockClusterRoleTemplateBindingClientMockRecorder) List(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockClusterRoleTemplateBindingClient)(nil).List), arg0, arg1)
}

// Patch mocks base method.
func (m *MockClusterRoleTemplateBindingClient) Patch(arg0, arg1 string, arg2 types.PatchType, arg3 []byte, arg4 ...string) (*v3.ClusterRoleTemplateBinding, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1, arg2, arg3}
	for _, a := range arg4 {
		varargs = append(varargs, a)
...
func (mr *MockClusterRoleTemplateBindingClientMockRecorder) Patch(arg0, arg1, arg2, arg3 interface{}, arg4 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1, arg2, arg3}, arg4...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Patch", reflect.TypeOf((*MockClusterRoleTemplateBindingClient)(nil).Patch), varargs...)
}

// Update mocks base method.
func (m *MockClusterRoleTemplateBindingClient) Update(arg0 *v3.ClusterRoleTemplateBinding) (*v3.ClusterRoleTemplateBinding, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", arg0)
	ret0, _ := ret[0].(*v3.ClusterRoleTemplateBinding)
	ret1, _ := ret[1].(error)
...
func (mr *MockClusterRoleTemplateBindingClientMockRecorder) Update(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockClusterRoleTemplateBindingClient)(nil).Update), arg0)
}

// Watch mocks base method.
func (m *MockClusterRoleTemplateBindingClient) Watch(arg0 string, arg1 v1.ListOptions) (watch.Interface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Watch", arg0, arg1)
	ret0, _ := ret[0].(watch.Interface)
	ret1, _ := ret[1].(error)
...
func (mr *MockClusterRoleTemplateBindingClientMockRecorder) Watch(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockClusterRoleTemplateBindingClient)(nil).Watch), arg0, arg1)
}
